...
ActiveRecord::Schema.define(version: 2019_11_24_185533) do
  ...
  create_table "greedy_grab_bag_games", force: :cascade do |t|
    t.integer "creator"
    t.string "group_name"
    t.string "game_title"
  ...
  create_table "secret_santa_games", force: :cascade do |t|
    t.integer "creator"
    t.string "group_name"
    t.string "game_title"
